...
public unsafe class CustomCharacterModule : FhModule {
    ...
    public static FhMethodHandle<MsGetRomItem> _MsGetRomItem =>
    ...
    public static FhMethodHandle<MsGetExcelData> _MsGetExcelData =>
        new ( new FhMethodLocation("FFX.exe", 0x3AB890) );

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate uint MsGetSaveItemNum(uint param_1);
    public static FhMethodHandle<MsGetSaveItemNum> _MsGetSaveItemNum =>
    ...
    public static FhMethodHandle<FUN_00a59710> _FUN_00a59710 =>
    ...
    public static FhMethodHandle<FUN_00a59760> _FUN_00a59760 =>
    ...
    public static FhMethodHandle<FUN_00a5bad0> _FUN_00a5bad0 =>
    ...
    public static FhMethodHandle<FFXVu0InterVectorXYZ> _FFXVu0InterVectorXYZ =>
    ...
    public static FhMethodHandle<graphicDrawUIAbmapElement> _graphicDrawUIAbmapElement =>
        new ( new FhMethodLocation("FFX.exe", 0x23EAE0) );

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void* FUN_008b70e0(nint param_1, int* param_2, int* param_3);
    public static FhMethodHandle<FUN_008b70e0> _FUN_008b70e0 =>
    ...
    public static FhMethodHandle<pppInitEnv> _pppInitEnv =>
        new ( new FhMethodLocation("FFX.exe", 0x316AB0) );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate uint MsGetSaveConfigHiragana();
    public static FhMethodHandle<MsGetSaveConfigHiragana> _MsGetSaveConfigHiragana =>
    ...
    public static FhMethodHandle<AbmapFindNextConnectingNode> _AbmapFindNextConnectingNode =>
        new ( new FhMethodLocation("FFX.exe", 0x656E00) );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void restoreVf00Register();
    public static FhMethodHandle<restoreVf00Register> _restoreVf00Register =>
    ...
    public static FhMethodHandle<FUN_00a5b400> _FUN_00a5b400 =>
    ...
    public static FhMethodHandle<FUN_00a5ad30> _FUN_00a5ad30 =>
    ...
    public static FhMethodHandle<FFXVu0MulVector> _FFXVu0MulVector =>
        new ( new FhMethodLocation("FFX.exe", 0x002ed710) );

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void graphicFontGetScreenWH(int* out_width, int* out_height);
    public static FhMethodHandle<graphicFontGetScreenWH> _graphicFontGetScreenWH =>
    ...
    public static FhMethodHandle<graphicAbmapGetVertexInfo> _graphicAbmapGetVertexInfo =>
    ...
    public static FhMethodHandle<FUN_00a560d0> _FUN_00a560d0 =>
    ...
    public static FhMethodHandle<FUN_00a56160> _FUN_00a56160 =>
    ...
    public static FhMethodHandle<AbmapManager_AllocBuffMemory> _AbmapManager_AllocBuffMemory =>
    ...
    public static FhMethodHandle<op1_md_draw_eiabm_sphe> _op1_md_draw_eiabm_sphe =>
        new ( new FhMethodLocation("FFX.exe", 0x668140) );

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void FUN_00a53510();
    public static FhMethodHandle<FUN_00a53510> _FUN_00a53510 =>
    ...
    public static FhMethodHandle<FUN_008efd90> _FUN_008efd90 =>
        new ( new FhMethodLocation("FFX.exe", 0x4EFD90) );

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void eiAbmParaGet();
    public static FhMethodHandle<eiAbmParaGet> _eiAbmParaGet =>
    ...
    public static FhMethodHandle<FUN_00a5d120> _FUN_00a5d120 =>
        new ( new FhMethodLocation("FFX.exe", 0x65d120) );

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool FUN_00a45800(int chr_id, int nodes_idx);
    public static FhMethodHandle<FUN_00a45800> _FUN_00a45800 =>
    ...
    public override bool init(FhModContext mod_context, FileStream global_state_file) {
        ...
        return _FUN_00a44d30                      .hook(this, h_FUN_00a44d30)
            && _FUN_00a45010                      .hook(this, h_FUN_00a45010)
            && _abmap_get_chr_point               .hook(this, h_abmap_get_chr_point)
            && _FUN_00a47d50                      .hook(this, h_FUN_00a47d50)
            && _FUN_00a47f00                      .hook(this, h_FUN_00a47f00)
            && _abmap_set_chr_posInternal_00a48a80.hook(this, h_abmap_set_chr_posInternal_00a48a80)
            && _FUN_00a48c80                      .hook(this, h_FUN_00a48c80)
            && _FUN_00a49590                      .hook(this, h_FUN_00a49590)
            && _FUN_00a4b790                      .hook(this, h_FUN_00a4b790)
            && _FUN_00a4c8d0                      .hook(this, h_FUN_00a4c8d0)
            && _eiAbmStart                        .hook(this, h_eiAbmStart)
            && _FUN_00a560d0                      .hook(this, h_FUN_00a560d0)
            && _FUN_00a56160                      .hook(this, h_FUN_00a56160)
            && _FUN_00a57f80                      .hook(this, h_FUN_00a57f80)
            && _FUN_00a58080                      .hook(this, h_FUN_00a58080)
            && _FUN_00a58ec0                      .hook(this, h_FUN_00a58ec0)
            && _FUN_00a598a0                      .hook(this, h_FUN_00a598a0)
            && _FUN_00a59990                      .hook(this, h_FUN_00a59990)
            && _FUN_00a5a4b0                      .hook(this, h_FUN_00a5a4b0)
            && _FUN_00a5a990                      .hook(this, h_FUN_00a5a990)
            && _FUN_00a5b030                      .hook(this, h_FUN_00a5b030)
            && _FUN_00a5b7b0                      .hook(this, h_FUN_00a5b7b0)
            && _FUN_00a5b980                      .hook(this, h_FUN_00a5b980)
            && _FUN_00a5bb70                      .hook(this, h_FUN_00a5bb70)
            && _FUN_008a8ef0                      .hook(this, h_FUN_008a8ef0)
            && _FUN_008bddc0                      .hook(this, h_FUN_008bddc0)
            && _FUN_00a505e0                      .hook(this, h_FUN_00a505e0)
            && _FUN_00a50ed0                      .hook(this, h_FUN_00a50ed0)
            && _FUN_00a534c0                      .hook(this, h_FUN_00a534c0)
            && _op1_md_draw_eiabm_sphe            .hook(this, h_op1_md_draw_eiabm_sphe)
            && _AbmapManager_AllocBuffMemory      .hook(this, h_AbmapManager_AllocBuffMemory) // Testing
            && _FUN_00a53510                      .hook(this, h_FUN_00a53510)
            && _FUN_00a4b4b0                      .hook(this, h_FUN_00a4b4b0)
            && _FUN_00a53de0                      .hook(this, h_FUN_00a53de0)
            && _FUN_008efd90                      .hook(this, h_FUN_008efd90)
            && _eiAbmParaGet                      .hook(this, h_eiAbmParaGet)
            && _FUN_00a5d120                      .hook(this, h_FUN_00a5d120)
            && _FUN_00a45800                      .hook(this, h_FUN_00a45800);
    }
    ...
    private void h_FUN_00a44d30() {
        ...
        if (0 < sphere_grid_menu_ptr->menus[8].num_entries) {
            ...
            do {
                ...
                uVar4 = _MsGetSaveItemNum.fnptr!(uVar2);
                if (uVar4 == 0) {
                    //*puVar6 = 1;
                    entry.unknown1 = 1;
                }
                    ...
                    local_28._0xc = 0;
                    pMVar5 = _MsGetRomItem.fnptr!(uVar2, &local_c);
                    if (pMVar5->command_pdata.sphere_grid_role == 0xff) {
                        local_28.desc = 0;
                    }
                    else {
                        local_28.desc =
                             (int)_MsGetExcelData.fnptr!(pMVar5->command_pdata.sphere_grid_role, sphere_bin_ptr, &local_c);
                    }
                    if ((void*)local_28.desc != (void*)0x0) {
                        if (*(byte*)(local_28.desc + 0xc) == ' ') {
                            _FUN_00a59710.fnptr!((nint)FhUtil.ptr_at<nint>(__addr_FUN_00a49440), &local_28);
                        }
                        else {
                            _FUN_00a59760.fnptr!(uVar1, (nint)FhUtil.ptr_at<nint>(__addr_FUN_00a49440), &local_28);
                        }
                    }
                    if (local_28._0xc == 0) {
                        //*puVar6 = 1;
    ...
    void h_FUN_00a45010() {
        ...
        _FUN_00a58ff0.fnptr!(0x0);
        if ((lpamng->__0x115CD == 0) && (lpamng->__0x115B0 == 0)) {
            _FUN_00a58ec0.fnptr!();
            if (lpamng->__0x115B0 == 0) {
                if (lpamng->__0x115C4 == 0) {
                    lpamng->__0x115C4 = 1;
                    _FUN_00a48f20.fnptr!(6);
                }
                uVar2 = lpamng->abmap_input[1];
                if ((uVar2 & 0x20) != 0) {
                    _SndSepPlaySimple.fnptr!(0x80000001);
                    lpamng->__0x11666 = 0;
                    _FUN_00a48c20.fnptr!(6);
                    _FUN_00a48c20.fnptr!(1);
                    _FUN_00a48c20.fnptr!(2);
                    _FUN_00a48c20.fnptr!(3);
                    _FUN_00a48c20.fnptr!(4);
                    _FUN_00a48c20.fnptr!(5);
                    lpamng->__0x115C8 = 0;
                    _FUN_00a48e40.fnptr!(custom_party_infos[lpamng->current_chr_id].current_node_idx, 0x3e800000);
                    return;
                }
                if ((uVar2 & 0x40) != 0) {
                    _SndSepPlaySimple.fnptr!(0x80000001);
                    ...
                    *(byte*)((int)&sphere_grid_menu_ptr->menus[10].num_columns + 1) = 1;
                    ...
                    _FUN_00a59860.fnptr!(0xb, FhUtil.ptr_at<nint>(0x656060));
    ...
    int h_abmap_get_chr_point(int param_1) {
        ...
        bVar1 = _MsGetSavePlyJoined.fnptr!((byte)param_1);
        if (bVar1 == 0) {
            return -1;
        }
        ...
        if (bVar1 == 0) {
            ...
            if (bVar1 == 1) {
                ...
                if (1.0 <= progress) {
                    plVar2->__0x1164C = 2;
                    lpamng->__0x1164D = 0;
                    _SndSepPlaySimple.fnptr!(0x80000070);
                    plVar2 = lpamng;
                    ...
                    _pppCreateHeap.fnptr!(p_DAT_01a86034, p_DAT_016c1830, 0x7d000);
                    _FUN_00a5bad0.fnptr!(p_DAT_01a86060, 1, local_18.X, local_18.Y, 0, 0, 0, 0, 0.5f, 0.5f, 0.5f);
                    custom_party_infos[lpamng->moving_chr_id].current_node_idx = lpamng->move_last_target_node_idx;
                    _FUN_00a5a990.fnptr!(lpamng->moving_chr_id);
                    _FUN_00a58080.fnptr!(lpamng->moving_chr_id);
                    lpamng->__0x115C7 = 1;
                    _FUN_00a5b030.fnptr!();
                    return;
                }
                _FFXVu0InterVectorXYZ.fnptr!(&local_28, &local_18, &lpamng->move_prev_node_pos, progress);
    ...
    void h_abmap_set_chr_posInternal_00a48a80(int chr_id, short node_idx) {
        ...
        _pppCreateHeap.fnptr!(p_DAT_01a86034, p_DAT_016c1830, 0x7d000);
        _FUN_00a5bad0.fnptr!(p_DAT_01a86060, 2, _lpamng->nodes[current_node].x,
    ...
    void h_FUN_00a49590() {
        ...
        save_ability_map = _MsGetSaveAbilityMap.fnptr!();
        node_idx = 0;
        plVar3 = lpamng;
                ...
                fixed (int* local_128 = _local_128) {
                    ...
                    fixed (float* local_118 = _local_118) {
                        ...
                        fixed (byte* local_108 = _local_108) {
                            ...
                            piVar3 = (float*)_user_malloc.fnptr!(0x1ec);
                            ...
                            do {
                                ...
                                local_118[2] = 1.0f;
                                _FUN_00642a80.fnptr!(local_128, local_118);
                            ...
                            switchD_00a4bd71_caseD_4:
                                ...
                                if (!(0.5 < local_26c == float.IsNaN(local_26c))) {
                                    ...
                                    _graphicDrawUIAbmapElement.fnptr!(&local_240, local_108, 5);
                                ...
                                _graphicDrawUIAbmapElement.fnptr!(&local_240, local_108, 5);
                                _FUN_008b70e0.fnptr!((nint)pSVar5->chr_name, &local_28c, &local_294);
                                bVar2 = (byte)(pSVar5->__0x4E & 3);
                                if ((bVar2 == 1) || (bVar2 == 2)) {
                                ...
                                *p_ppvCurPrimp = _FUN_008e8fb0.fnptr!(*p_ppvCurPrimp + 0x10, 0xffffffff, pSVar5->chr_name,
                            ...
                            LAB_00a4c3cd:
                                ...
                                if (local_284 == 0) {
                                    _user_free.fnptr!((nint)local_290);
                                    return;
                                }
                            } while (true);
                        }
    ...
    void h_FUN_00a4c8d0() {
        ...
        _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &lpamng->__0x113E0, &local_58);
        _FUN_00a657c0.fnptr!(iVar4, &local_150, 4, &lpamng->__0x116A4);
        ...
        do {
            ...
            if ((0.0 < chr_info->pos_circle_radius != float.IsNaN(chr_info->pos_circle_radius)) &&
               (((uVar2 != chr_info->current_node_idx || (uVar5 == lpamng->current_chr_id)) || (uVar5 == num_characters)))) {
                ...
                local_58.M33 = local_58.M11;
                _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &lpamng->__0x113E0, &local_58);
                _FUN_00a657c0.fnptr!(DAT_023057f8, &local_150, 4, &lpamng->__0x116A4);
            }
            uVar5 = uVar5 + 1;
            //pfVar6 = pfVar6 + 0x14;
            chr_info += 1;
    ...
    void h_eiAbmStart() {
        ...
        *p_DAT_01a85f70 = 0;
        ...
        do {
            joined = _MsGetSavePlyJoined.fnptr!((byte)chr_id);
            if (joined == 1) {
                lpamng->available_indicators = (byte)(lpamng->available_indicators | joined << ((byte)chr_id & 0x1f));
                _FUN_00a57f80.fnptr!(chr_id, 0, 0x40000000, 0x80404040, 0x80404040, 0x80808080);
            }
            chr_id = chr_id + 1;
        ...
        _FUN_00a57120.fnptr!();
        _FUN_00a5b030.fnptr!();
        _pppInitEnv.fnptr!(p_DAT_01a86034, DAT_02305800, p_DAT_016c1830, 0x7d000);
        ...
        *(uint*)&menuData->menus[7].pos1 = 0x00cd0030;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x1f, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x1e, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[7].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[7].is_full =
        ...
        *(uint*)&menuData->menus[6].pos1 = 0x01640030;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x23, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 0, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 1, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 7, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 0xb, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 8, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 0xc, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 9, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 0xd, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 10, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.status_txt, 0xe, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[1].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[1].is_full =
        ...
        *(uint*)&menuData->menus[9].pos1 = 0x00cd0030;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x2b, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        ...
        *(uint*)&menuData->menus[10].pos1 = 0x00cd0030;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x2e, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        ...
        *(uint*)&menuData->menus[0xb].pos1 = 0x00f50030;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x2c, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        ...
        uVar8 = _MsGetSaveConfigHiragana.fnptr!();
        pbVar9 = _MsMenuGetText.fnptr!(MenuTextFile.mmain_txt, 0x2d, uVar8 & 1);
        menuData = sphere_grid_menu_ptr;
        sVar2 = sphere_grid_menu_ptr->menus[0xb].num_entries;
        if (sVar2 < 0x40) {
            sphere_grid_menu_ptr->menus[0xb].num_entries = (short)(sVar2 + 1);
        ...
        _graphicAbmapCreate.fnptr!(*(void**)&lpamng->__0x116A4);
        _graphicDeActivateLoadingScreen.fnptr!();
        _graphicSetFlipVsnc.fnptr!(2);
        *p_DAT_01a860ec = (int)_user_malloc.fnptr!(0x200);
        *p_DAT_01a860f0 = (int)_user_malloc.fnptr!(0x200);
        return;
    }
    ...
    void h_FUN_00a560d0(nint param_1, int param_2, nint param_3, int param_4) {
        ...
        if (param_4 != 0) {
            ...
            *(int*)&pSVar1->menus[8].pos3 = 0x01640030;
            ...
            _FUN_00a5b980.fnptr!((uint)lpamng->current_chr_id,
    ...
    void h_FUN_00a56160(nint param_1, int param_2, nint param_3, int param_4) {
        ...
        plVar3 = lpamng;
        if (param_3 == 0) {
            _SndSepPlaySimple.fnptr!(0x80000052);
            _FUN_00786fb0.fnptr!(lpamng->current_chr_id, lpamng->slv_queued);
        }
        else if (param_3 == 1) {
            iVar4 = (int)lpamng->link_count;
            _SndSepPlaySimple.fnptr!(0x80000004);
            if (iVar4 != 0) {
            ...
            lpamng->__0x115C7 = 1;
            _FUN_00a5b030.fnptr!();
            _FUN_00a48d70.fnptr!(custom_party_infos[bVar1].current_node_idx, 0.5f);
            if (lpamng->__0x115B0 == 0) {
                lpamng->__0x115B0 = lpamng->__0x115A8;
    ...
    int custom_TOGetEasyMesWFontLInterModeChrName(byte* name, int param_2) {
        ...
        *p_DAT_018663a8 = 0;
        while (cur_char != 0x0) {
            name = _FUN_008b7bb0.fnptr!(name, 0, &char_width, param_2);
    ...
    void h_FUN_00a57f80(uint chr_id, int node_idx, uint param_3, uint param_4, uint param_5, uint param_6) {
        ...
        if ((int)chr_id < num_characters) {
            chr_name = _TOGetSaveChrName.fnptr!(chr_id);
    ...
    void h_FUN_00a58ec0() {
        ...
        bVar1 = _TkMenuGetCurrentPlayer.fnptr!();
        ...
        _FUN_00a48d70.fnptr!(custom_party_infos[lpamng->current_chr_id].current_node_idx, 0.25f);
        if (lpamng->__0x115B0 == 0) {
            lpamng->__0x115B0 = lpamng->__0x115A8;
            lpamng->__0x115A8 = (int)FhUtil.ptr_at<nint>(0x659E80); // FUN_00a59e80;
        }
    ...
    void h_FUN_00a598a0() {
        ...
        if (0 < sphere_grid_menu_ptr->menus[8].num_entries) {
            ...
            do {
                iVar3 = _FUN_00a49310.fnptr!(lpamng->current_chr_id, uVar1, (uint)(piVar5[1] & 0xffff));
                *(bool*)piVar5 = iVar3 == 0;
                iVar4 = iVar4 + 1;
                piVar5 = piVar5 + 3;
    ...
    void h_FUN_00a59990() {
        ...
        if (!float.IsNaN(fVar2) && 1.0f < fVar2 != (fVar2 == 1.0f)) {
            do {
                ...
                uVar5 = _AbmapFindNextConnectingNode.fnptr!(lpamng->move_next_target_node_idx, lpamng->move_last_target_node_idx,
                                     &local_44);
                ...
                //fVar8 = _CIsqrt.fnptr!((float10)ABS(asmreg_vf10->x));
        ...
        if (uVar3 == -1) {
            ...
            local_58.Z = 0.0f;
            local_58.W = 1.0f;
            _FUN_00a563b0.fnptr!(&pSVar7->pos, &lpamng->move_prev_node_pos, &local_18, &local_58,
                         lpamng->moving_progress);
        }
    ...
    void h_FUN_00a5a4b0() {
        ...
        pfVar4 = local_78;
            do {
                ...
                _FUN_00a482d0.fnptr!(pSVar3, pfVar4);
                do {
                    iVar5 = 0;
                    pfVar6 = local_78;
                    while (true) {
                        if (local_7c <= iVar5) goto LAB_00a5a56c;
                        bVar1 = _FUN_00a49270.fnptr!(pfVar4, pfVar6);
                ...
                do {
                    ...
                    while (true) {
                        ...
                        //   (bVar1 = FUN_00a49270(pfVar4, pfVar6), CONCAT31(extraout_var_00, bVar1) != 0)) break;
                             _FUN_00a49270.fnptr!(pfVar4, pfVar6)) break;
                        iVar5 = iVar5 + 1;
                        pfVar6 = pfVar6 + 1;
                    }
                    pSVar3->__0x4E = (byte)(pSVar3->__0x4E + 1);
    ...
    void h_FUN_00a5b7b0() {
        ...
        uVar2 = _FUN_007854a0.fnptr!(bVar6);
        _FUN_00a474d0.fnptr!(uVar1, uVar2, bVar6);
        ...
        uVar4 = _FUN_007854a0.fnptr!(lpamng->current_chr_id);
        iVar5 = lpamng->node_count;
        if (iVar5 != 0) {
            pbVar3 = (byte*)&lpamng->nodes[0].properties;
            do {
        ...
        lpamng->__0x1169C = 0;
        lpamng->slv_queued = 0;
        _FUN_00a48d70.fnptr!(uVar1, 0.25f);
        if (lpamng->__0x115B0 != 0) {
            lpamng->__0x115C3 = 1;
            return;
        }
    ...
    void h_FUN_00a5b980(uint chr_id, short node_idx, uint item_id) {
        ...
        _FUN_00a5b400.fnptr!((int)chr_id, node_idx, item_id, 3);
        lpamng->__0x116A0 = 0;
        lpamng->__0x1169C = 0;
        ...
        psVar2 = _FUN_00a56a40.fnptr!(&local_8, &custom_party_infos[lpamng->current_chr_id].pos,
        ...
        if ((psVar2 != (SphereGridNode*)0x0) && (node_to_select != lpamng->selected_node_idx)) {
            _FUN_00a48d70.fnptr!((int)node_to_select, 0.5f);
            if (lpamng->__0x115B0 == 0) {
                lpamng->__0x115B0 = lpamng->__0x115A8;
                lpamng->__0x115A8 = (int)FhUtil.ptr_at<nint>(0x659E80); // FUN_00a59e80;
                lpamng->__0x115C3 = 1;
    ...
    void h_FUN_00a5bb70() {
        ...
        ability_map = _MsGetSaveAbilityMap.fnptr!();
        node_idx = 0;
        if (0 < lpamng->node_count) {
            node_offset = 0;
            do {
    ...
    void h_FUN_008a8ef0(uint param_1) {
        ...
        *p_DAT_01841bf0 = 0;
        *p_DAT_01841bf4 = 0;
        pbVar2 = _MsGetSaveInParty.fnptr!(&local_8);
        uVar7 = 0;
        uVar6 = 0;
        iVar4 = 0;
        local_c = 0;
        ...
        *p_DAT_01841be4_PauseMenuFrontlineNum = uVar6;
        pbVar2 = _MsGetSaveOutParty.fnptr!(&local_8);
        iVar4 = 0;
        if (0 < local_8) {
            do {
                bVar1 = pbVar2[iVar4];
        ...
        *p_DAT_01841bf0 = uVar7;
        do {
            idx = (byte)iVar4;
            bVar1 = _MsGetSavePlyJoined.fnptr!(idx);
            //if (bVar1 &&
            //   ((uVar5 != 0x10000 &&
        ...
        do {
            if (Globals.Battle.reward_data->in_battle[(int)uVar4] != false) {
                ...
                *(short*)((int)puVar5 + 2) = (short)uVar4;
                uVar1 = _FUN_008b9e60.fnptr!(uVar4);
                *(byte*)(puVar5 + 1) = uVar1;
                uVar1 = (byte)_FUN_008b9e70.fnptr!(uVar4);
                *(byte*)((int)puVar5 + 5) = uVar1;
                ply_chr_id = _FUN_008ba330.fnptr!(local_8, iVar3);
        ...
        if (iVar6 != 0) {
            ...
            do {
                ...
                if (uVar1 == 0xff) {
                    ...
                    do {
                        plVar5 = lpamng;
                        _FUN_00a5ad30.fnptr!(&local_98, node, 1.0f);
                        _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &plVar5->__0x113E0, &local_98);
                        local_58.M43 = -1.0f;
                        local_150.rgba = 0;
                        _op1_md_draw_eiabm_sphe.fnptr!(DAT_023057ec, &local_150, (lpamng->node_count - iVar6) + -1, iVar7);
                        iVar7 = iVar7 + 1;
                    ...
                    if (local_164->x == 0x1000) {
                        ...
                        do {
                            plVar5 = lpamng;
                            _FUN_00a5ad30.fnptr!(&local_98, node, pSVar4[uVar1].__0x10);
                            _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &plVar5->__0x113E0, &local_98);
                            local_58.M43 = -1.0f;
                            local_150.rgba = 0;
                            _op1_md_draw_eiabm_sphe.fnptr!(DAT_023057ec, &local_150, (lpamng->node_count - iVar6) + -1, iVar7);
                        ...
                        while (true) {
                            ...
                            _FUN_00a5ad30.fnptr!(&local_98, node, plVar5->node_type_infos[uVar1].__0x10);
                            //_logger.Debug($"Pos: {node->pos} + {local_164->xy}");
                            _FUN_00a5a360.fnptr!(&local_98, node, local_164, 0.0008f);
                            _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &plVar8->__0x113E0, &local_98);
                            _op1_md_draw_eiabm_sphe.fnptr!(DAT_023057ec, &local_150, (lpamng->node_count - iVar6) + -1, chr_id);
                            chr_id = chr_id + 1;
    ...
    void h_FUN_00a534c0() {
        ...
        fixed (int* local_148 = _local_148) {
            ...
            if (-1 < (int)lpamng->should_update_node) {
                _FUN_00a50ed0.fnptr!((int)lpamng->should_update_node);
            }
                    ...
                    if (pVVar10->x != 0x1000) {
                        ...
                        do {
                            if ((bVar4 & 1) != 0) {
                                ...
                                _FUN_00a5ad30.fnptr!(&local_98, node, plVar3->node_type_infos[uVar1].__0x10);
                                _FUN_00a5a360.fnptr!(&local_98, node, pVVar10, 0.0008f);
                                _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &lpamng->__0x113E0, &local_98);
                                _op1_md_draw_eiabm_sphe.fnptr!(DAT_023057ec, &local_1c0, (lpamng->node_count - iVar11) + -1, iVar5);
                            }
                            piVar7 = piVar7 + 4;
                            iVar5 = iVar5 + -1;
                            bVar4 = (byte)(bVar4 >> 1);
    ...
    void h_FUN_00a50ed0(int param_1) {
        ...
        if (local_164->x == 0x1000) {
            ...
            do {
                pLVar5 = lpamng;
                _FUN_00a5ad30.fnptr!(&local_98, pSVar1, lpamng->node_type_infos[(int)SVar2].__0x10);
                _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &pLVar5->__0x113E0, &local_98);
                local_58.M43 = -1.0f;
                local_150.rgba = 0;
                _op1_md_draw_eiabm_sphe.fnptr!(DAT_023057ec, &local_150, param_1, iVar6);
                iVar6 = iVar6 + -1;
            ...
            if (local_151 == 0) {
                ...
                //iVar6 = _FUN_009497e0.fnptr!(pSVar1, 0x1000);
            ...
            while (true) {
                ...
                _FUN_00a5ad30.fnptr!(&local_98, pSVar1, pLVar5->node_type_infos[(int)SVar2].__0x10);
                _FUN_00a5a360.fnptr!(&local_98, pSVar1, local_164, 0.0008f);
                _cdc_FFXVu0MulMatrix.fnptr!(&local_d8, &pLVar7->__0x113E0, &local_98);
                _op1_md_draw_eiabm_sphe.fnptr!(DAT_023057ec, &local_150, param_1, local_15c);
    ...
    abmapVertexInfo* h_AbmapManager_AllocBuffMemory(nint abmapManager, int param_1) {
        ...
        if (param_1 == 7) {
            puVar3 = (abmapVertexInfo*)_user_malloc.fnptr!(0xd0);
            ...
            VertexInfo_0x94* pVVar3 = (VertexInfo_0x94*)_user_malloc.fnptr!(0x6c);
            ...
            puVar3->field97_0x94->field3_0xc = (float*)_user_malloc.fnptr!((nint)field3_0xc_size);
            puVar3->field97_0x94->field4_0x10 = (float*)_user_malloc.fnptr!((nint)field4_0x10_size);
            puVar3->field97_0x94->field5_0x14 = (float*)_user_malloc.fnptr!((nint)field5_0x14_size);
            puVar3->field97_0x94->field6_0x18 = (float*)_user_malloc.fnptr!((nint)field6_0x18_size);
            puVar3->field97_0x94->field7_0x1c = (short*)_user_malloc.fnptr!((nint)field7_0x1c_size);
            puVar3->field97_0x94->field8_0x20 = (byte*)_user_malloc.fnptr!(0x100);
            ...
            if (*(int*)abmapManager == 0) {
                ...
                FhLangId iVar11 = _TOGetFFXLang.fnptr!();
            ...
            return _AbmapManager_AllocBuffMemory.chain_from(h_AbmapManager_AllocBuffMemory).fnptr!(abmapManager, param_1);
        }
        ...
        if (0 < puVar3->field96_0x90) {
            ...
            do {
                fixed (byte* p_local_108 = local_108) {
                    _fiosUnifyFilename.fnptr!((nint)(*(byte**)((int)&puVar3->field97_0x94->field8_0x20 + iVar12)), (nint)p_local_108,
                                  0x100);
    ...
    int h_op1_md_draw_eiabm_sphe(int param_1, temp_FUN_00a4c8d0_struct* param_2, int node_idx, int chr_id) {
        ...
        if (_gParticleDoNotRender == 0) {
            ...
            _FFXVu0MulVector.fnptr!(&rgba, &local_68, &rgba);
            _graphicFontGetScreenWH.fnptr!(&local_a8, &local_a4);
            ...
            nint tempStringPointer = Marshal.StringToHGlobalAnsi("NoTexture");
            paVar6 = _graphicAbmapGetVertexInfo.fnptr!((byte*)tempStringPointer, 7);
            Marshal.FreeHGlobal(tempStringPointer);
            ...
            if (-1 < chr_id) {
                ...
                _FFXVu0MulVector.fnptr!((Vector4*)&local_48.M11, &rgba, (Vector4*)&local_48.M11);
                _FFXVu0MulVector.fnptr!((Vector4*)&local_48.M21, &rgba, (Vector4*)&local_48.M21);
                _FFXVu0MulVector.fnptr!((Vector4*)&local_48.M31, &rgba, (Vector4*)&local_48.M31);
                _FFXVu0MulVector.fnptr!((Vector4*)&local_48.M41, &rgba, (Vector4*)&local_48.M41);
    ...
    void h_FUN_00a4b4b0() {
        ...
        pfVar3 = (uint*)_user_malloc.fnptr!(0x1ec);
        plVar2 = lpamng;
        ...
        if (iVar4 != 0) {
            ...
            do {
                ...
                if ((pbVar5[-1] & '\x01' << (bVar1 & 0x1f)) == 0) {
                    ...
                    _FUN_00a51720.fnptr!(pfVar3, (float*)*(SphereGridLinkPoint**)(pbVar5 + 3), (int)*pbVar5);
                }
                    ...
                    _FUN_00a521a0.fnptr!(pfVar3, (float*)*(SphereGridLinkPoint**)(pbVar5 + 3), (int)*pbVar5);
                }
                else {
                    switch (lpamng->current_chr_id) {
                        case 0:
        ...
        _user_free.fnptr!((nint)pfVar3);
        return;
    }

    // Initializes Sphere Grid
    void h_FUN_00a53de0(SaveSphereGrid* save_sphere_grid) {
        _FUN_00a53de0.chain_from(h_FUN_00a53de0).fnptr!(save_sphere_grid);
        custom_party_selected_node_idx = new short[num_characters - 7];
    ...
    void h_eiAbmParaGet() {
        ...
        do {
            ...
            evasion = 0;
            accuracy = 0;
            ability_map = _MsGetChrAbilityMap.fnptr!((uint)chr_id);
            save_abmap = _MsGetSaveAbilityMap.fnptr!();
            node_idx = 0;
            ...
            do {
                if ((save_abmap->nodes[node_idx].activated_by & (byte)chr_bit) != 0) {
                    panel = (ExcelBlock_panel*)
                            _MsGetExcelData.fnptr!((int)save_abmap->nodes[node_idx].node_type, _panel_bin_ptr, &dummy_ref)
                    ;
                    ...
                    _MsSetChrAbilityMapCommand.fnptr!((uint)chr_id, (uint)panel->ability_id);
                    chr_bit = local_50;
                }
                node_idx = node_idx + 1;
            } while (node_idx < 1024);
    ...
    void h_FUN_00a53510() {
        ...
        if (iVar3 != -2) {
            if (iVar3 < 0) {
                _FUN_00639280.fnptr!(1);
                _FUN_00a51340.fnptr!();
            } else {
                _FUN_00a51560.fnptr!(iVar3);
            }
        }
        pLVar2 = lpamng;
        ...
        while (iVar3 != 0) {
            ...
            if (pSVar7->node_type != NodeType.NULL) {
                _FUN_00a5ad30.fnptr!(&local_d8, pSVar7, 1.0f);
                _cdc_FFXVu0MulMatrix.fnptr!(&local_98, &lpamng->__0x113E0, &local_d8);
                ...
                _FUN_007f4900.fnptr!(*(int*)((int)&pLVar2->node_type_infos[(int)pSVar7->node_type] + 8), &local_110,
    ...
    int h_FUN_008efd90(int param_1, int chr_id, int param_3, int param_4, int param_5, int param_6, int param_7, int param_8, int param_9) {
        if (chr_id == 7) {
            ...
            if (param_9 == 6) {
                texture_name = _TOGetShapTextureName.fnptr!(0x2ed0);
                _TOGetImageWH.fnptr!(0x2ed0, &local_b4, &local_b8);
                ...
                _graphicDrawUIElement.fnptr!(&local_a0, texture_name, 1, 0, 6);
                return param_1;
            }
            texture_name = _TOGetShapTextureName.fnptr!(0x2ed0);
            _TOGetImageWH.fnptr!(0x2ed0, &local_b4, &local_b8);
            ...
            local_a0.ints1[2] = param_7;
            local_a0.ints1[3] = param_8;
            _graphicDrawUIElement.fnptr!(&local_a0, texture_name, 1, 0, 0);
            return param_1;
        } else {
            return _FUN_008efd90.chain_from(h_FUN_008efd90).fnptr!(param_1, chr_id, param_3, param_4, param_5, param_6, param_7, param_8, param_9);
        }
    }
    ...
    bool h_FUN_00a5d120(byte sphere_type, int node_idx, ExcelBlock_panel* param_3, int chr_id) {
        ...
        switch (sphere_type) {
            ...
            case 0x16:
                ...
                break;
            case 8:
                iVar3 = _FUN_00a457d0.fnptr!(chr_id, node_idx);
                if (iVar3 != 0) {
                    return false;
                }
            ...
            LAB_00a5d1cc:
                if (bVar4) {
                LAB_00a5d1d4:
                    iVar3 = _FUN_00a45800.fnptr!(chr_id, node_idx) ? 1 : 0;
                LAB_00a5d1d9:
                    if (iVar3 != 0) {
                        return true;
                    }
                ...
                break;
            case 0xc:
                iVar3 = _FUN_00a45870.fnptr!(chr_id);
                if (iVar3 == node_idx) {
                    return false;
                }
                iVar3 = _FUN_00a457d0.fnptr!(chr_id, node_idx);
            ...
            case 0xe:
                ...
                for (byte i = 0; i < num_characters; i++) {
                    if (chr_id != i && _MsGetSavePlyJoined.fnptr!(i) != 0 && _FUN_00a45870.fnptr!(i) == node_idx) {
                        return true;
                    }
                }
                return false;
            ...
            case 0x18:
                ...
                if ((((iVar3 == 0) && (1 < bVar1)) && (bVar1 < 0xc)) &&
                   (_FUN_00a45800.fnptr!(chr_id, node_idx))) {
                    return true;
                }
                break;
        }
    ...
    bool h_FUN_00a45800(int chr_id, int nodes_idx) {
        ...
        for (byte i = 0; i < num_characters; i++) {
            if (i != chr_id && _MsGetSavePlyJoined.fnptr!(i) == 1 && (activated_by & (1 << i)) != 0) {
                return true;
            }
        }
        return false;
